...
public class Tutorial {                                                              //
    ...
    public static void onCommand(@NotNull CommandSender sender, @NotNull String[] args) {
        if (args.length == 1 || args[1].equals("1")) {
            for (int i = 0; i < 10; i++)
                sender.sendMessage("");
            sender.sendMessage(speakings.get(0) + ChatColor.GRAY + "" + ChatColor.STRIKETHROUGH + "                                        ");
        ...
        switch (page) {
            ...
            case 8:
                ...
                if (immunityType == 0) {
                    ...
                    sendCommandMessage(sender, "{command}. Immunity is permanent and costs " + NumberFormatting.currencyPrefix + NumberFormatting.formatNumber((double) ConfigOptions.permanentCost) + NumberFormatting.currencySuffix + ChatColor.WHITE + ".", "/bounty immunity", true);
